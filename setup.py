...
def package_data():
    ...
    """
    file_set = []
    for root, dirs, files in os.walk("athanor_jobs"):
        for f in files:
...
setup(
    ...
    url="https://github.com/volundmush/athanor_jobs",
    description="",
    license="MIT",
    ...
    project_urls={
        "Source": "https://github.com/volundmush/athanor_jobs",
        "Issue tracker": "https://github.com/volundmush/athanor_jobs/issues",
    },
)
